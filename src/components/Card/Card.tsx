...
export default function Card(props: Props): ReactElement {
    const { imgSrc, imgAlt, productName, productDescription, strikePrice, price } = props;
    return (
        <div className="m-4 md:m-4 lg:m-4 shadow-md rounded border border-solid border-gray-200">
            ...
            <div className="p-1">
                <h2 className="py-1 text-lg text-gray-700">{productName}</h2>
                <div className="flex justify-between">
                    <div>
                        <p className="leading-9 text-gray-600 text-sm float-left">{productDescription}</p>
                    </div>
                    <div className="flex">
